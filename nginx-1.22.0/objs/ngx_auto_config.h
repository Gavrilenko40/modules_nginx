#define NGX_CONFIGURE " --prefix=/usr/share/nginx --conf-path=/etc/nginx/nginx.conf --http-log-path=/var/log/nginx/access.log --error-log-path=/var/log/nginx/error.log --lock-path=/var/lock/nginx.lock --pid-path=/run/nginx.pid --modules-path=/usr/lib/nginx/modules --http-proxy-temp-path=/var/lib/nginx/proxy --add-module=/root/cache/nginx-aws-auth-module --with-http_auth_request_module --with-stream --with-stream_ssl_module --with-stream_ssl_preread_module --with-http_ssl_module --with-debug --with-compat --with-http_slice_module --with-threads --with-http_addition_module --with-file-aio"
